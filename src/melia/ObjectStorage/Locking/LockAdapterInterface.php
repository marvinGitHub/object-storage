...
interface LockAdapterInterface
{
    ...
    public function aquireSharedLock(string $uuid, int $timeout = LockAdapterInterface::LOCK_TIMEOUT_DEFAULT);

    public function aquireExclusiveLock(string $uuid, int $timeout = LockAdapterInterface::LOCK_TIMEOUT_DEFAULT);
