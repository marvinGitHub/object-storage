...
interface LockAdapterInterface
{
    ...
    public function acquireSharedLock(string $uuid, int $timeout = LockAdapterInterface::LOCK_TIMEOUT_DEFAULT);

    public function acquireExclusiveLock(string $uuid, int $timeout = LockAdapterInterface::LOCK_TIMEOUT_DEFAULT);
